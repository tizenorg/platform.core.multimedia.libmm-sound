...
/usr/bin/vconftool set -t double file/private/sound/volume/balance 0.0 -g 29 -f
/usr/bin/vconftool set -t int file/private/sound/volume/muteall 0 -g 29 -f
...
/usr/bin/vconftool set -t int file/private/sound/volume/system 9 -g 29 -f
/usr/bin/vconftool set -t int file/private/sound/volume/notification 11 -g 29 -f
/usr/bin/vconftool set -t int file/private/sound/volume/alarm 7 -g 29 -f
/usr/bin/vconftool set -t int file/private/sound/volume/ringtone 11 -g 29 -f
/usr/bin/vconftool set -t int file/private/sound/volume/media 7 -g 29 -f
/usr/bin/vconftool set -t int file/private/sound/volume/call 4 -g 29 -f
/usr/bin/vconftool set -t int file/private/sound/volume/voip 4 -g 29 -f
/usr/bin/vconftool set -t int file/private/sound/volume/voice 7 -g 29 -f
