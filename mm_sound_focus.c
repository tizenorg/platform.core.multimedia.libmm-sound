...
EXPORT_API int mm_sound_focus_set_session_interrupt_callback(mm_sound_focus_session_interrupt_cb callback, void *user_data)
{
	int ret = MM_ERROR_NONE;
	debug_fenter();
...
EXPORT_API int mm_sound_register_focus_for_session(int id, int pid, const char *stream_type, mm_sound_focus_changed_cb callback, void *user_data)
{
	int ret = MM_ERROR_NONE;
...
EXPORT_API int mm_sound_get_stream_type_of_acquired_focus(int focus_type, char **stream_type, char **additional_info)
{
	int ret = MM_ERROR_NONE;
...
EXPORT_API int mm_sound_set_focus_watch_callback(mm_sound_focus_type_e focus_type, mm_sound_focus_changed_watch_cb callback, void *user_data, int *id)
{
	int ret = MM_ERROR_NONE;
...
EXPORT_API int mm_sound_set_focus_watch_callback_for_session(int pid, mm_sound_focus_type_e focus_type, mm_sound_focus_changed_watch_cb callback, void *user_data, int *id)
{
	int ret = MM_ERROR_NONE;
