...
static const gchar introspection_xml[] = "<node>" "  <interface name='org.tizen.FocusServer1'>" "    <method name='GetUniqueId'>" "      <arg name='id' type='i' direction='out'/>" "    </method>" "    <method name='RegisterFocus'>"
	...
	"    </method>" "    <method name='GetAcquiredFocusStreamType'>" "      <arg name='focus_type' type='i' direction='in'/>" "      <arg name='stream_type' type='s' direction='out'/>" "      <arg name='additional_info' type='s' direction='out'/>" "    </method>" "    <method name='AcquireFocus'>" "      <arg name='pid' type='i' direction='in'/>" "      <arg name='handle_id' type='i' direction='in'/>" "      <arg name='focus_type' type='i' direction='in'/>" "      <arg name='name' type='s' direction='in'/>" "      <arg name='is_for_session' type='b' direction='in'/>" "    </method>" "    <method name='ReleaseFocus'>" "      <arg name='pid' type='i' direction='in'/>" "      <arg name='handle_id' type='i' direction='in'/>" "      <arg name='focus_type' type='i' direction='in'/>" "      <arg name='name' type='s' direction='in'/>" "      <arg name='is_for_session' type='b' direction='in'/>" "    </method>" "    <method name='WatchFocus'>"
#ifdef SUPPORT_CONTAINER
#ifdef USE_SECURITY
	" 	 <arg name='container' type='ay' direction='in'/>"
#else
...
#endif
#endif
	"      <arg name='pid' type='i' direction='in'/>" "      <arg name='handle_id' type='i' direction='in'/>" "      <arg name='focus_type' type='i' direction='in'/>" "      <arg name='is_for_session' type='b' direction='in'/>" "    </method>" "    <method name='UnwatchFocus'>" "      <arg name='pid' type='i' direction='in'/>" "      <arg name='handle_id' type='i' direction='in'/>" "      <arg name='is_for_session' type='b' direction='in'/>" "    </method>" "    <method name='EmergentExitFocus'>" "      <arg name='pid' type='i' direction='in'/>" "    </method>" "  </interface>" "</node>";
...
static void on_bus_acquired(GDBusConnection * connection, const gchar * name, gpointer user_data)
{
	...
	conn_g = connection;
	reg_id = g_dbus_connection_register_object(connection, OBJECT_FOCUS_SERVER, introspection_data->interfaces[0], &interface_vtable, NULL, NULL, NULL);
	if (!reg_id) {
