...
EXPORT_API int mm_sound_add_device_connected_callback(mm_sound_device_flags_e flags, mm_sound_device_connected_cb func, void *user_data, unsigned int *subs_id)
{
	int ret = MM_ERROR_NONE;
...
EXPORT_API int mm_sound_add_device_information_changed_callback(mm_sound_device_flags_e flags, mm_sound_device_info_changed_cb func, void *user_data, unsigned int *subs_id)
{
	int ret = MM_ERROR_NONE;
