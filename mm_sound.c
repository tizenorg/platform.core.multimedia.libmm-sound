...
EXPORT_API
int mm_sound_play_sound_with_stream_info(const char *filename, char *stream_type, int stream_id, int loop, mm_sound_stop_callback_func callback, void *data, int *handle)
{
	MMSoundPlayParam param = { 0, };
	int err;
