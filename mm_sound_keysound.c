...
static int mm_sound_play_keysound_ex(const char *filename, int volume_config, ipc_type_t ipc_type);
...
{
	return mm_sound_play_keysound_ex(filename, volume_config, IPC_TYPE_DBUS);
}
