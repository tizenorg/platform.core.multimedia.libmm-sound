...
static int _sound_server_dbus_signal_unsubscribe(unsigned int id)
{
	GDBusConnection *conn = NULL;
	...
	_dbus_unsubscribe_signal(conn, id);
...
int mm_sound_client_dbus_remove_test_callback(unsigned int id)
{
	int ret = MM_ERROR_NONE;
	debug_fenter();

	if ((ret = _sound_server_dbus_signal_unsubscribe(id)) != MM_ERROR_NONE) {
...
int mm_sound_client_dbus_remove_device_connected_callback(unsigned int id)
{
	int ret = MM_ERROR_NONE;
	debug_fenter();
...
int mm_sound_client_dbus_remove_device_info_changed_callback(unsigned int id)
{
	int ret = MM_ERROR_NONE;
	debug_fenter();
...
int mm_sound_client_dbus_remove_volume_changed_callback(unsigned int id)
{
	int ret = MM_ERROR_NONE;
	debug_fenter();
